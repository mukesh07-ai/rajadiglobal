            ...
            <motion.button
                ...
                className={cn(
                    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
                    {
                        ...
                        "border border-white/20 bg-transparent shadow-sm hover:bg-slate-800 hover:text-white": variant === "outline",
                        "hover:bg-slate-800 hover:text-white": variant === "ghost",
                        "text-blue-500 underline-offset-4 hover:underline": variant === "link",
                        "bg-gradient-to-r from-blue-600 to-teal-500 text-white hover:from-blue-500 hover:to-teal-400 border-0": variant === "gradient",
